...
class CreateEmploitimeMatiereTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('emploitime_matiere', function (Blueprint $table) {
            $table->increments('emploitime_id');
    ...
    {
        Schema::dropIfExists('emploitime_matiere');
    }
}
